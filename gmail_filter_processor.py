...
"""
    ...
    def _generate_skipped_report(self):
        ...
        # Single file for all skipped emails (append mode)
...
"""
        ...
        print(f"📄 Skipped emails appended to: {skipped_path}")
    ...
    def _generate_processing_index(self):
        ...
        # Single file for all processed emails (append mode)
...
"""
        ...
        print(f"📊 Processed emails appended to: {processed_path}")
        print(f"   Total processed emails logged: {len(self.processed_email_details)}")
...
"""
    ...
    def run(self):
        ...
        try:
            ...
            # Generate skipped emails report (append mode)
            if self.skipped_emails:
                self._generate_skipped_report()
            
            # Generate processed emails log (append mode)
